/**
 * Generates public/fastcourt-loading.json — FastCourt "dash in" loading animation.
 *
...
// --- tagline: acid caps rise up under the wordmark --------------------------
...
const lottie = {
  ...
  w: 800,
  h: 600,
  nm: 'FastCourt — loading (dash in)',
  ddd: 0,
  assets,
  layers: [mark, ...letterLayers, tagline, ...whooshes, bg],
  markers: [
    { tm: 0, cm: 'intro', dr: 90 },
...
const out = join(root, 'public/fastcourt-loading.json');
